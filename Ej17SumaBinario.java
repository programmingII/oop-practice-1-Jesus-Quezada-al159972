...
public class Ej17SumaBinario{
	public static void main(String args[]){
		...
		int result = entero1+entero2; //realizo la suma de enteros, declaro la variable de resultado hasta el momento en el que la usare
		System.out.println("La suma de los binarios "+ n1 + " + "+ n2 +" es: "+ Integer.toBinaryString(result)); //con toBinaryString convierto a binario y al mismo tiempo lo muestor en pantalla 
	}
}